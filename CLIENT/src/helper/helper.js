...
export async function SignUp(credentials) {
  try {
    const { data: { msg } } = await Axios.post('https://solaroptai-final-server.vercel.app/api/register', credentials);
...
export async function loginUser(credentials) {
  try {
    const { data } = await Axios.post('https://solaroptai-final-server.vercel.app/api/login', credentials);
...
console.log(user);
    ...
    const { data: { msg } } = await Axios.post('https://solaroptai-final-server.vercel.app/api/visualizations', {
      email: user,
...
export async function GetUserLocations() {
  try {
    ...
    const { data } = await Axios.get('https://solaroptai-final-server.vercel.app/api/visualizations', {
...
export async function DeleteLocation(location_name) {
  try {
      ...
      const { data: { msg } } = await Axios.delete(`https://solaroptai-final-server.vercel.app/api/visualizations?location_name=${encodeURIComponent(location_name)}`, {
          headers: {
              "user-email": user,
          }
      });
